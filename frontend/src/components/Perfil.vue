      ...
      <form @submit.prevent="saveProfile">
        <div class="space-y-6">
          ...
          <div v-if="props.userType === 'profissional'">
            ...
            <input type="text" id="specialty" v-model="profile.specialty" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
          </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
      ...
      <form @submit.prevent="changePassword" class="space-y-4">
        <div>
          ...
          <input type="password" id="current-password" v-model="password.current" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        </div>
        <div>
          <label for="new-password" class="block text-sm font-medium text-gray-700">Nova Senha</label>
          <input type="password" id="new-password" v-model="password.new" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        </div>
        <div>
          <label for="confirm-password" class="block text-sm font-medium text-gray-700">Confirmar Nova Senha</label>
          <input type="password" id="confirm-password" v-model="password.confirm" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        </div>
