  ...
  <aside class="w-full lg:w-64 bg-white shadow-lg lg:shadow-none lg:border-r border-gray-200 flex flex-col">
    <div class="flex items-center justify-between p-6 border-b border-gray-200">
      <div class="flex items-center space-x-3">
        <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8bGFuZHNjYXBlfGVufDB8fDB8fHww"
             alt="Usuário Paciente"
    ...
    <nav class="p-4 flex-1">
      <ul class="space-y-1">
        ...
        <li>
          <a href="#" @click.prevent="$emit('navigate', 'anotacoes')" class="sidebar-item">
            <i class="fa-solid fa-book fa-fw mr-3"></i>
            <span>Anotações Diárias</span>
          </a>
        </li>
        <li>
...
.sidebar-item.active {
  background-color: #DBF7E9; /* soft emerald-ish background */
  color: #166534; /* darker emerald */
}
</style>
