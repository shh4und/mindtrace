      ...
      <form @submit.prevent="saveProfile">
        <div class="space-y-6">
          ...
          <div>
            ...
            <input type="text" id="name" v-model="profile.nome" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-colors text-gray-900">
          </div>
          ...
          <div>
            ...
            <textarea id="bio" v-model="profile.bio" rows="4" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-colors text-gray-900"></textarea>
          </div>
        </div>
        <div class="flex justify-end mt-6">
          <button type="submit" class="bg-emerald-600 text-white font-medium px-6 py-2 rounded-lg hover:bg-emerald-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
            Salvar Alterações
          </button>
        </div>
      </form>
    ...
    <div class="w-full max-w-2xl bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
      ...
      <form @submit.prevent="changePassword" class="space-y-4">
        <div>
          ...
          <input type="password" id="current-password" v-model="password.senha_atual" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-colors text-gray-900">
        </div>
        <div>
          <label for="new-password" class="block text-sm font-medium text-gray-700">Nova Senha</label>
          <input type="password" id="new-password" v-model="password.nova_senha" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-colors text-gray-900">
        </div>
        <div>
          <label for="confirm-password" class="block text-sm font-medium text-gray-700">Confirmar Nova Senha</label>
          <input type="password" id="confirm-password" v-model="password.nova_senha_re" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-colors text-gray-900">
        </div>
