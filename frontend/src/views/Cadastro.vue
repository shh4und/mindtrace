<template>
  <div class="min-h-screen bg-gray-50">
    <header class="w-full p-6">
      <router-link to="/login" class="text-xl font-semibold text-gray-900 hover:text-blue-600 transition-colors">MindTrace</router-link>
    </header>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors text-gray-900"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <div class="relative">
                    <input
                      ...
                      class="w-full px-4 py-3 pr-12 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors"
                      required
                    />
                    <button
                      type="button"
                    ...
                    >
                      <svg v-if="passwordFieldType === 'password'" id="eyeOff" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878L21 21"></path>
                      </svg>
                      <svg v-else id="eyeOn" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default {
  ...
  methods: {
    handleRegister() {
      ...
      console.log('Dados do formulário de cadastro:', this.form);
      alert('Cadastro realizado com sucesso! Bem-vindo(a), ' + this.form.fullName + '!');
