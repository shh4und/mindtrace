...
const PacienteDashboard = () =>
  import("@/views/dashboard-paciente/PacienteDashboard.vue");
const PacienteResumo = () => import("@/views/dashboard-paciente/Resumo.vue");
const PacienteHumor = () =>
  import("@/views/dashboard-paciente/RegistroHumor.vue");
const PacienteRelatorio = () => import("@/views/shared/Relatorio.vue");
const PacienteVincular = () =>
  import("@/views/dashboard-paciente/VincularProfissional.vue");
const PacienteEditarPerfil = () => import("@/views/shared/EditarPerfil.vue");
const PacienteQuestionariosAtribuidos = () =>
...
const ProfissionalEditarPerfil = () =>
  import("@/views/shared/EditarPerfil.vue");
const ProfissionalRelatorio = () => import("@/views/shared/Relatorio.vue");
const ProfissionalAtribuirQuestionario = () =>
  import("@/views/dashboard-profissional/AtribuirQuestionario.vue");
const ProfissionalQuestionariosAtribuidos = () =>
  import("@/views/dashboard-profissional/QuestionariosAtribuidos.vue");
const ProfissionalVisualizarRespostas = () =>
  import("@/views/dashboard-profissional/VisualizarRespostas.vue");
  ...
  routes: [
    ...
    // Dashboard Profissional com nested routes
    {
      ...
      children: [
        ...
        {
          path: "visualizar-respostas/:atribuicaoId",
          name: "profissional-visualizar-respostas",
          component: ProfissionalVisualizarRespostas,
          props: true,
        },
        {
          path: "editar-perfil",
...
router.beforeEach((to, from, next) => {
  ...
  const isProfissionalRoute = to.matched.some(
    (record) => record.meta.role === TipoUsuario.Profissional
  );
